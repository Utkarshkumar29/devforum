...
const UploadFeed = () => {
    ...
    const [poll_description, setPoll_Description] = useState<string | null>(null)
    ...
    const handleAddOptions = (e: React.MouseEvent) => {
        e.preventDefault()
    ...
    // ─────────────────────────────────────────────
    // Reusable AI Writer block (used in multiple modals)
    // ─────────────────────────────────────────────
    ...
    const AiWriterBlock = () => (
        <div className="rounded-2xl bg-[#2a2a2a] border border-[#3a2a5a] p-4">
            ...
            {showAiInput && (
                <div className="mt-3 flex flex-col gap-2">
                    <p className="text-[#666] text-xs">
                        Describe what you want to post about and Gemini will write it for you.
                    </p>
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 px-4 py-2.5 rounded-xl bg-[#1a1a1a] border border-[#3a2a5a]
                                       outline-none text-sm placeholder:text-[#444] text-white
                                       focus:border-[#7D42F5] transition"
                        />
                        <button
                            type="button"
                        ...
                        <div className="flex flex-wrap gap-2 mt-1">
                            {[
                                ...
                                <button
                                    ...
                                    className="px-3 py-1 rounded-full bg-[#1a1a1a] border border-[#3a2a5a]
                                               text-[#a053de] text-xs hover:bg-[#3a2a5a] transition"
                                >
                                    {chip}
                                </button>
                            ))}
            ...
            {/* Shows a preview chip when AI has filled the editor */}
            {!showAiInput && description && (
                <p className="text-[#555] text-xs mt-2 flex items-center gap-1.5">
                    <i className="fa-solid fa-check text-[#a053de]" />
                    AI text applied — you can edit it freely below
                </p>
            )}
        </div>
    )
    ...
    // ─────────────────────────────────────────────
    // Shared footer buttons (Post + Schedule)
    // ─────────────────────────────────────────────

    const ModalFooter = ({ showSchedule = true }: { showSchedule?: boolean }) => (
        ...
        <>
            ...
            <div className="w-full max-w-[700px] bg-[#1a1a1a] rounded-[16px] border border-[#262626] px-[24px] py-[16px]">
                <div className="flex items-center justify-center gap-3 border-b border-[#262626] pb-[12px]">
                    <Image
                        src={userDetails?.user?.photo_url || "/default-avatar.png"}
                        width={40}
                        height={40}
                ...
                <div className="justify-between items-center flex pt-[16px]">
                    <div className="flex flex-row justify-center gap-4">
                        <div onClick={() => setAddImageModal(true)} className="cursor-pointer">
                            <i className="fa-solid fa-image text-[#a053de]" />
                        </div>
                        <div onClick={() => setAddVideoModal(true)} className="cursor-pointer">
                            <i className="fa-solid fa-video text-[#a053de]" />
                        </div>
                        <div onClick={() => setAddFileModal(true)} className="cursor-pointer">
                            <i className="fa-solid fa-file text-[#a053de]" />
                        </div>
                                    ...
                                    {time && date && (
                                        <div className="border-[#262626] w-full px-[24px] py-[16px] rounded-2xl bg-[#2a2a2a] flex justify-between items-center">
                                            ...
                                            <button
                                                ...
                                                className="cursor-pointer text-[#7D42F5] border border-[#7D42F5] px-[24px] py-[2px] rounded-xl font-medium text-sm"
                                            >
                                                Edit
                                            </button>
                                        </div>
                            ...
                            <DialogPanel className="w-[700px] h-auto bg-[#1a1a1a] rounded-2xl overflow-y-auto shadow-xl">
                                ...
                                <Description as="div">
                                    <div className="w-full h-full p-[34px] flex gap-5 flex-col overflow-y-auto max-h-[450px]">
                                        ...
                                        {/* Drop zone */}
                                        <div
                                            className="cursor-pointer border border-dashed border-[#262626] w-full min-h-[150px] flex flex-col justify-center items-center rounded-3xl bg-[#2a2a2a] hover:border-[#7D42F5] transition"
                                        ...
                                        >
                                            <input
                                                ...
                                                type="file"
                                                multiple
                                                onChange={(e) => { if (e.target.files) handleImages(e.target.files) }}
                                            />
                                        ...
                                        {imageArray.length > 0 && (
                                            <div className="flex h-[400px] justify-center items-center">
                                                <div className="items-center gap-4 flex relative h-auto aspect-square rounded-xl overflow-hidden">
                                                    <div
                                                        onClick={imageArray.length > 1 ? handlePrevImage : undefined}
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <button
                                                            ...
                                                            className="absolute top-3 right-3 bg-black/60 text-white w-[32px] h-[32px] rounded-full hover:bg-black/80 flex items-center justify-center"
                                                        >
                                                            ✕
                                                        </button>
                                                        <span className="absolute bottom-3 right-3 bg-black/60 text-white text-xs px-2 py-1 rounded-full">
                                                            {imageArrayIndex + 1} / {imageArray.length}
                                                        </span>
                                                    </div>
                                                    <div
                                                        onClick={imageArray.length > 1 ? handleNextImage : undefined}
                                                        className={imageArray.length <= 1 ? "opacity-30 cursor-not-allowed" : "cursor-pointer"}
                                                    >
                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4">
                        ...
                        >
                            <DialogPanel className="w-[700px] h-auto bg-[#1a1a1a] rounded-2xl overflow-y-auto shadow-xl">
                                    ...
                                    <div className="w-full h-full p-[34px] flex gap-5 flex-col overflow-y-auto max-h-[450px]">
                                        ...
                                        >
                                            <input
                                                ...
                                                className="hidden"
                                                type="file"
                                                onChange={(e) => { if (e.target.files) handleVideo(e.target.files) }}
                                            />
                                        ...
                                        {videoPreview && (
                                            <div className="relative">
                                                <video
                                                    src={videoPreview}
                                                    controls
                                                    className="w-full max-h-[300px] rounded-xl mt-2"
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => setVideoPreview(null)}
                                                    className="absolute top-4 right-2 bg-black/60 text-white w-[32px] h-[32px] rounded-full hover:bg-black/80 flex items-center justify-center"
                                                >
                                                    ✕
                                                </button>
                                            </div>
                                ...
                                <ModalFooter showSchedule={false} />
                            </DialogPanel>
                        </TransitionChild>
                    </div>
                </Dialog>
                                    ...
                                    <div className="w-full h-full p-[34px] flex gap-5 flex-col overflow-y-auto max-h-[450px]">
                                        ...
                                        >
                                            <input
                                                ...
                                                type="file"
                                                className="hidden"
                                                onChange={(e) => { if (e.target.files) handleFile(e.target.files) }}
                                            />
                                        ...
                                        {fileName && (
                                            <div className="flex items-center justify-between p-4 bg-[#2a2a2a] rounded-xl text-white">
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => { setFileName(null); setFileObj(null) }}
                                    ...
                                    <div className="w-full h-full p-[34px] flex gap-5 flex-col overflow-y-auto max-h-[450px]">
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <input
                                                    type="text"
                                                    className="w-full mt-2 p-3 rounded-lg bg-[#2a2a2a] outline-none text-white placeholder:text-[#555] border border-[#333] focus:border-[#7D42F5] transition"
                                                    placeholder="What do you want to ask?"
                                                    value={poll_description ?? ""}
                                                    onChange={(e) => setPoll_Description(e.target.value)}
                                                />
                                            </div>
                                            ...
                                            <div className="flex flex-col gap-3 mt-4 w-full">
                                                    ...
                                                    <div key={index} className="flex items-center gap-2">
                                                        ...
                                                        {pollOptions.length > 2 && (
                                                            <button
                                                                ...
                                                                className="text-[#666] hover:text-rose-400 transition"
                                                            >
                                                                <i className="fa-solid fa-xmark" />
                                                            </button>
                                                        )}
                                                ...
                                                {pollOptions.length < 4 && (
                                                    <button
                                                        ...
                                                        className="self-start border border-[#7D42F5] text-[#7D42F5] rounded-2xl px-[16px] py-[8px] cursor-pointer text-sm hover:bg-[#7D42F5]/10 transition"
                                                    >
                                                        + Add Option
                                                    </button>
                                                )}
                            ...
                            <DialogPanel className="w-[700px] h-auto bg-[#1a1a1a] rounded-2xl overflow-y-auto shadow-xl">
                                    ...
                                    <div className="w-full h-full p-[34px] flex gap-6 flex-col">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <input
                                                ...
                                                type="date"
                                                value={date ?? ""}
                                                className="cursor-pointer border border-[#333] w-full px-[24px] py-[16px] rounded-2xl bg-[#2a2a2a] text-white outline-none focus:border-[#7D42F5] transition"
                                            />
                                        </div>
                                        <div className="flex flex-col gap-1">
                                ...
                                <div className="border border-[#262626] flex justify-end py-[16px] px-[24px] gap-3">
                                    <button
                                        ...
                                        className="cursor-pointer text-[#666] border border-[#333] px-6 py-2 rounded-xl font-medium text-sm hover:border-[#555] transition"
                                    >
                                        Clear
                                    </button>
                                    <button
